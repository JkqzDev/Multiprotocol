...
class v486AvailableCommandsPacket extends AvailableCommandsPacket {
    ...
    public static function fromLatest(AvailableCommandsPacket $pk): self {
        $result = new self;
        $result->commandData = $pk->commandData;
        $result->hardcodedEnums = $pk->hardcodedEnums;
        $result->softEnums = $pk->softEnums;
        $result->enumConstraints = $pk->enumConstraints;
        return $result;
    }
